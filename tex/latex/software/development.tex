...
\begin{figure}[!htbp]
    ...
    \subfigure[Normal Sigmoid Function]{\label{fig:sigmoid}\includegraphics[width=70mm]{software/plots/sigmoid.pdf}}
    \subfigure[Approximated Ends]{\label{fig:sigmoid-ends}\includegraphics[width=70mm]{software/plots/sigmoid-ends.pdf}}
    \subfigure[Approximated With Lines]{\label{fig:sigmoid-soft}\includegraphics[width=70mm]{software/plots/sigmoid-soft.pdf}}
    \subfigure[Approximated With Linear Equation]{\label{fig:sigmoid-hard}\includegraphics[width=70mm]{software/plots/sigmoid-hard.pdf}}
\end{figure}
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|}
        ...
        Variable Initialisations for the Heap & 116 \\
        LibC Values & 12 \\
        \hline
    \end{tabular}
